...
const restaurantSearch = function (query) {
  ...
  yelpAxios.get(`/businesses/matches${query}`).then(function (response) {
    console.log("Response-----", response.data);
    return response.data;
  });
};
...
const createNewTask = function (
  ...
  const params = [user_id, category_id, title, to_do_task, to_do_date];
...
const createNewCategory = async function (
  user_id,
  title,
  to_do_task,
  to_do_date
